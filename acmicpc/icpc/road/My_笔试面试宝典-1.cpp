...
[80102+]  m_robby - mysql存储引擎
 InnoDB 和 MyISAM是许多人在使用MySQL时最常用的两个表类型，这两个表类型各有优劣，视具体应用而定。
...
[90102] B/S与C/S有什么区别？
 在 C/S 架构中，服务器通常采用高性能的PC，而且采用大型数据库。客户端需要安装专用的客户端软件。
...
[90109] 基本的HTTP流程有哪些？
 HTTP，其主要服务器与浏览器之间的通信。HTTP把客户端浏览器的请求发送到服务器，并把响应的网页内容由服务器返回到客户端浏览器。     HTTP 流程，10步略。
