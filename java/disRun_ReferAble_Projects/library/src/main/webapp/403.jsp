...
<body>
<div class="error">
<img src="http://sources.corp.qunar.com/QunarLibrary/403.png" />
	<h1><a title="“去哪儿”旅游搜索引擎"  target="_top" href="http://www.qunar.com/"><span>“去哪儿”旅游搜索引擎</span></a></h1>
	<h2>你暂无页面访问权限</h2>
	<dl>
		<dt>您可以：</dt>
		<dd><a href="javascript:history.go(-1);" class="back">返回至刚才的页面</a> </dd>
		<dd><a href="/login.jsp" >到登录页面</a> </dd>
	</dl>
</div>
